<%@ Page Language="C#" AutoEventWireup="true" CodeFile="print_site_order.aspx.cs" Inherits="print_site_order" %>
...
<body >
    ...
    <tr>    
      <td   align="right"> 
        ...
        <tr>
<td align="center">
        <asp:Label runat="server" Font-Names="Arial" Font-Bold="true" Font-Size="Larger" ID="Label3">Site Order</asp:Label><br />
    </td>

        </tr>
    <tr>
    <td align="left">
        <asp:Label runat="server" Font-Names="Arial" Font-Bold="true" Font-Size="Larger" ID="Label2"   >Order No : blu<%Response.Write(Page.Request.QueryString["itemId"]); %></asp:Label><br />
    </td>
    </tr>
    <tr>
    <td align="left">
