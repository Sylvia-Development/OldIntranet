<%@ Page Language="C#" AutoEventWireup="true" CodeFile="print_all_package_barcodes_by_wall.aspx.cs" Inherits="print_all_package_barcodes_by_wall" %>
...
<script src="Scripts/jquery-1.4.4.min.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(document).ready(setTimeout(function () { window.print() }, 5000));      
