<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="Default3.aspx.cs" Inherits="Default3" %>
...
<asp:ListView ID="QuotesInProgressFormView" runat="server"
       ...
       <EmptyDataTemplate>
            <table cellpadding="4" ID="itemPlaceholderContainer" runat="server" border="0" class="tableSpacing">
        ...
        <LayoutTemplate>
            ...
            <table cellpadding="4" ID="itemPlaceholderContainer" runat="server" border="0" class="tableSpacing paddedTable" >
             <tr  class="tableheaderrow">
...
<table >
    <tr>
    <td colspan="2" ><table width="100%"><tr><td class="greenrow">100% Bonus</td><td class="bluerow">75% Bonus</td><td class="purplerow">50% Bonus</td><td class="amberow">25% Bonus</td><td class="redrow">No Bonus</td></tr></table></td>
</tr>
<tr>
 <td style="vertical-align:top;">
...
<asp:ListView ID="ListView3" runat="server"
       ...
       <EmptyDataTemplate>
        ...
        <LayoutTemplate>
            ...
            <table cellpadding="4" ID="itemPlaceholderContainer" runat="server" border="0" class="zebra paddedTable">
             <tr class="tableheaderrow">
