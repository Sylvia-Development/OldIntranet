<%@ Page Title="" Language="C#" MasterPageFile="~/SetupLeftNavMasterPage.master" AutoEventWireup="true" CodeFile="setup_default_reminders.aspx.cs" Inherits="setup_default_reminders" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">

<asp:LinqDataSource ID="ContactDataSource" runat="server" 
        ContextTypeName="IntranetDataDataContext" 
        TableName="reminder_defaults"
